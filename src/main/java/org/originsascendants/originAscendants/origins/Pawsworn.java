...
public class Pawsworn extends Origin {
    ...
    public Pawsworn(PlayerState state) {
        super(state);
        this.primaryAbilityDoc = new AbilityDoc("Pounce", "Leap at targets to start combat.");
        this.secondaryAbilityDoc = new AbilityDoc("Feral Swipe", "Quick claw attacks.");
        this.crouchAbilityDoc = new AbilityDoc("Stalker", "Crouch to gain stealth and safe fall.");
    }
    ...
    public void secondaryAbility() {
        abilityMessage("Feral Swipe used.");
    }

    @Override
    public void crouchOn() {
        abilityMessage("Stalker mode activated.");
    }
}
