...
public class Phytokin extends Origin {
    ...
    public Phytokin(PlayerState state) {
        super(state);
        this.primaryAbilityDoc = new AbilityDoc("Bloom", "Grant plant-based buffs and interact with flora.");
        this.secondaryAbilityDoc = new AbilityDoc("Tend", "Heal plants and create small beneficial effects.");
        this.crouchAbilityDoc = new AbilityDoc("Root", "Root in place to gain regeneration.");
    }
    ...
    public void primaryAbility() {
        abilityMessage("Bloom activated.");
    }
    ...
    public void secondaryAbility() {
        abilityMessage("Tend used.");
    }

    @Override
    public void crouchOn() {
        abilityMessage("Rooted: regeneration incoming.");
    }
}
